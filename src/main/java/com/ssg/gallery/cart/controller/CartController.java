...
public class CartController {
    ...
    public ResponseEntity<?> readAll(@AuthenticationPrincipal LoginUser userDetails) {
    ...
    public ResponseEntity<?> push(@AuthenticationPrincipal LoginUser userDetails, @RequestBody CartRequest cartReq) {
        Integer memberId = userDetails.getId();
    ...
    public ResponseEntity<?> remove(@AuthenticationPrincipal LoginUser userDetails, @PathVariable("itemId") Integer itemId) {
        Integer memberId = userDetails.getId();
